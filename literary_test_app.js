...
(function () {
  ...
  function flowerSvg(key) {
    const svgs = {
      ...
      juhua: `<svg viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"><circle cx="24" cy="24" r="7" fill="#f9a825" stroke="#f57f17" stroke-width=".6"/>${Array.from({ length: 16 }, (_, i) => `<ellipse cx="24" cy="24" rx="3" ry="14" transform="rotate(${i * 22.5} 24 24)" fill="#ffca28" stroke="#f9a825" stroke-width=".5" opacity=".92"/>`).join('')}</svg>`,
